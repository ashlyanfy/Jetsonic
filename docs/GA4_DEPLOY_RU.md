...
Чек-лист приёмки — в [GA4_EVENTS_RU.md](GA4_EVENTS_RU.md): пройти по таблицам
событий и убедиться, что каждое приходит.
...
> — метка устройства живёт в localStorage, — иначе первые дни
